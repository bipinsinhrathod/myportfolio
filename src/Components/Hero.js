...
import Bipin from '../assets/b2.jpg'
    ...
    <>
      <section id='home' className='lg:h-[85vh] flex items-center bg-primary lg:bg-cover lg:bg-center lg:bg-no-repeat py-32 lg:py-0 overflow-hidden'>
        ...
        <div className='flex items-center h-full pt-8'>
            ...
            <a href={Resume} download={true} className='btn btn-md rounded-xl animate-bounce bg-accent hover:bg-accent-hover md:btn-lg transition-all'>Download CV</a>
            </div>
